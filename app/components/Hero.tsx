    ...
    <section id="home" className="min-h-screen flex items-center justify-center">
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
        ...
        <motion.div
          ...
          className="mb-8 md:mb-0 md:w-1/3 flex justify-center md:justify-start pl-4 md:pl-8"
        >
          <Image
        ...
        >
          <motion.h1
            className="text-5xl md:text-6xl font-bold text-custom-lightPeach mb-4"
          ...
          <motion.p
            className="text-lg text-custom-lightCream mb-6"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
